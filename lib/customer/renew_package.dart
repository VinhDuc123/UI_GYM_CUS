...
import 'package:codeui/customer/runtext.dart';
import 'package:codeui/customer/tng_basic.dart';
import 'package:codeui/customer/tng_extra.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:animated_text_kit/animated_text_kit.dart';

class RenewPackage extends StatefulWidget {
  const RenewPackage({Key key}) : super(key: key);

  @override
  State<RenewPackage> createState() => _RenewPackageState();
}
              ...
              buildButton(
                  ...
                  callback: () {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => TNGBasic()));
                  }),
              buildButton(
                  ...
                  callback: () {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => TNGExtra()));
                  }),
              SizedBox(height: 20)
            ],
          ),
