...
class TNGBasic extends StatefulWidget {
  const TNGBasic({Key key}) : super(key: key);

  @override
  State<TNGBasic> createState() => _TNGBasicState();
}

class _TNGBasicState extends State<TNGBasic>
          ...
          Expanded(
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    "Hội viên TNG từ ngày:  adad adawd dawd adad awda adad  ",
                    maxLines: 2,
